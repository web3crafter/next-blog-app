  ...
  return (
    <section className="pt-3 pb-10">
      <div className="flex items-center gap-3">
        ...
        <p className="text-sm">
          Ipsum dolor ea est ullamco ad tempor fugiat consequat duis sint
          nostrud fugiat exercitation consequat.
        </p>
      </div>
      {/* FLEX */}
      ...
      {/* GRID */}
      <div className="grid-cols-4 grid-rows-2 gap-5 my-3 sm:grid sm:h-[600px]">
        <TrendingCard
      ...
      <p className="text-sm">
        Sint ullamco ullamco qui quis. Enim nulla Lorem ad irure cupidatat
        reprehenderit non nulla quis tempor eiusmod. Occaecat minim laboris
        occaecat amet dolore labore ad culpa adipisicing et mollit consequat.
      </p>
    </section>
  )
}
